...
const CreationRulesBox: React.FC<CreationRulesBoxProps> = ({ isQuestPost }) => {
    ...
    const fontSize = { base: '14px', lg: '16px' };
    ...
    return (
        ...
        >
            ...
            <VStack spacing="3px" p="12px" bg={insideBg} align="left">
                <Text mt="4px" noOfLines={3} fontSize={fontSize} color="black" whiteSpace="pre-line">
                    {rules[0]}
                </Text>
                <Text mt="4px" noOfLines={2} fontSize={fontSize} color="black" whiteSpace="pre-line">
                    {rules[1]}
                </Text>
                <Text mt="4px" noOfLines={2} fontSize={fontSize} color="black" whiteSpace="pre-line">
                    {rules[2]}
